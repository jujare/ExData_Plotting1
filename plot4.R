...
plot(meter.dataset$Voltage, type="l", xaxt="n", ylab="Voltage")
axis(1, at=meter.dataset$DateTime, labels=meter.dataset$Weekday)
...
axis(1, at=meter.dataset$DateTime, labels=meter.dataset$Weekday)
legend("topright", lty=c(1,1,1), col = c("black", "blue", "red"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), cex = 0.5)

plot(meter.dataset$Global_reactive_power, type="l", xaxt="n", ylab="Global Reactive Power")
axis(1, at=meter.dataset$DateTime, labels=meter.dataset$Weekday)
